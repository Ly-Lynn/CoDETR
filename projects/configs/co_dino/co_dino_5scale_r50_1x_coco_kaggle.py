...
model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='/kaggle/CoDETR/data/pretrained_models/co_dino_5scale_r50_1x_coco.pth')),
    neck=dict(
        type='ChannelMapper',
...
data = dict(
    # 2:2 failed
    samples_per_gpu=1, # 1 sample per GPU
    workers_per_gpu=1, # 
